...
if st.session_state.models_loaded:
    ...
    with tab1:
        ...
        if uploaded_file is not None:
            ...
            missing_cols = [
                col for col in required_cols if col not in input_data.columns
            ]
            if missing_cols:
    ...
    with tab2:
        ...
        for i in range(7):
            ...
            with cols[i]:
                ...
                manual_data.append({"date": date, "store_id": store_id, "sales": sales})
    ...
    with tab3:
        ...
        with col2:
            avg_sales = st.number_input(
                "Average Daily Sales", value=5000, min_value=100
            )
        with col3:
        ...
        if st.button("Generate Sample Data", key="sample_btn"):
            ...
            input_data = pd.DataFrame(
                {"date": dates, "store_id": "store_001", "sales": sales}
            )
            ...
            if st.button(
                ...
                with st.spinner("Generating forecast..."):
                    ...
                    if results["success"]:
                        ...
                        with col4:
                            st.metric("Model Used", model_type.upper())
                        ...
                        with col2:
                            st.info(
                                "Forecast includes predictions with confidence intervals"
                            )
